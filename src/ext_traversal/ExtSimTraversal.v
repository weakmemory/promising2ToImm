...
(*              codom_rel (⦗issued (etc_TC T) ∪₁ eq e⦘ ⨾ rf ⨾ rmw) ⊆₁ *)
...
(*     unionL. *)
(*     { unionR left -> left. admit. } (* apply ETCCOH. *) *)
(*     unionR right. *)
...
(*     rewrite set_interC. *)
(*     arewrite (codom_rel (⦗eq e⦘ ⨾ rfe ⨾ rmw) ∩₁ dom_rel (⦗W_ex⦘ ⨾ sb ⨾ ⦗reserved T⦘) ⊆₁ ∅). *)
(*     2: basic_solver. *)
...
(*     sin_rewrite WF.(rmw_sb_W_in_rppo). *)
...
(*       assert (dom_sb_S_rfrmw G (mkETC (etc_TC T) (reserved T ∪₁ eq w)) rf *)
